...
def game():
    ...
    # create class allowing to color and underline text
    class color: 
        BOLD = '\033[1m'
        UNDERLINE = '\033[4m'
        END = '\033[0m'   

    # restart function allowing the player to restart the game or to quit the game
    def restart():
   ...
   # function for letter by letter printing
    def write_letter():    
    ...
    # character select function: sets skill attributes based on character selection
    ...
    # inventory select function: choose items and add to inventory
    ...
    # weapon select function: choose weapon and set attack damage values
    def weapon_select():
    ...
    # check menu function: check skills and inventory menu
    def check_menu():
    ...
    # walmart function: choose a powerful item and add its effect
    def walmart():
    ...
    # military armory function: guess 4-digit code to pick up overpowered weapon
    def military_armory():
    ...
    # choose path function: pick walmart or military armory
    def choose_path():
    ...
    # item select function: choose an item from inventory
    def item_select():
    ...
    #class to make zombies
    class Zombies():
        ATTRIBUTES = {'Health': 0, 'Attack' : 0}
        def __init__(self):
            self.ATTRIBUTES['Health'] += random.randint(30, 50)
            self.ATTRIBUTES['Attack'] += random.randint(5, 15)
        def __str__(self):
    ...
    #special type of zombie reserved for bosses
    class BossZombies(Zombies):
        ...
        def __init__(self, name):
            ...
            self.ATTRIBUTES['Attack'] = Zombies.ATTRIBUTES['Attack'] +  random.randint(10, 20)
        def getName(self):
          return (self.name)
        def __str__(self):
